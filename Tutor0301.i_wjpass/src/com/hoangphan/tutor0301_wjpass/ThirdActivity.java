...
public class ThirdActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String age = i3.getStringExtra("age");
        Log.d("Intent", name+" "+age);
        
        i4 = new Intent(this, FourActivity.class);
        i4.putExtras(i3); //put all content in i2 to i3
    ...
    public void gotoFour(View v){
      ...
      i4.putExtra("cloth", cloth);
      i4.putExtra("weapon", weapon);
      i4.putExtra("medicine", medicine);
      startActivity(i4);
    }
